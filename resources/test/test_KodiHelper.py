...
def test_load_server_certificate():
...
def test_search_result_listing():
    """ADD ME"""
    kodi_helper = KodiHelper()
    kodi_helper.set_library(library=LibraryMock())
    _actions = {'movie': 'play', 'show': 'show_dir'}
